...
0. How to clone to Rstudio so you can actually commit!
  - ...
1. Fork repo
...
4. Install jekyll
5. Run servr::jekyll()
6. Edit/Write a post and change the title so the name starts with the date
6. Figure out the url for the gh pages
7. 
...
![A scatterplot of the cars data](/figure/source/2015-01-10-how-to/cars-1.png) 
