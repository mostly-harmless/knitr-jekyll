...
1. Fork repo
2. Clone repo and edit Rmd file in _source
3. Install knitr and servr
4. Install jekyll
5. Figure out the url for the gh pages
6. Run servr::jekyll()
...
![A scatterplot of the cars data](/figure/source/how-to/cars-1.png) 
